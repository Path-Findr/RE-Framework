...
namespace PathFindrRoboticEnterpriseFramework
{
    ...
    {
        private Lazy<global::PathFindrRoboticEnterpriseFramework.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::PathFindrRoboticEnterpriseFramework.WorkflowRunnerService>(() => new global::PathFindrRoboticEnterpriseFramework.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::PathFindrRoboticEnterpriseFramework.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
